...
class ParamsTest extends TestCase
{
    ...
    {
        $param = Param::int('name');
        $this->assertEquals([
            "type" => "int",
            "name" => "name",
        ], $param->data());

        $param = Param::string('slug');
        $this->assertEquals([
            "type" => "string",
            "name" => "slug",
        ], $param->data());
        ...
        $param = Param::int('page');
        $this->assertEquals([
            "type" => "int",
            "name" => "page",
        ], $param->data());

        $param = Param::bool('enable');
        $this->assertEquals([
            "type" => "bool",
            "name" => "enable",
        ], $param->data());

        $param = Param::integer('page');
        $this->assertEquals(NULL, $param);
        ...
        $param = Param::type('weird_type');
        $this->assertEquals([
            "type" => "weird_type",
        ], $param->data());

        $param = Param::int('page')->default(7)->example(42)->optional()->possible([0, 42])->description('desc');
        $this->assertEquals([
            "type" => "int",
            "name" => "page",
            "required" => false,
        ...
        $param = Param::int('page')->required()->enum([0, 42])->desc('desc')->eg(42);
        $this->assertEquals([
            "type" => "int",
            "name" => "page",
            "required" => true,
